...
<body>
        ...
        <form action="/crud/index.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="titleEdit" name="titleEdit" aria-desribedby="emailHelp">
            </div>
  ...
  <div class="container my-4">
    ...
    <form action="/crud/index.php" method="POST">
      <div class="form-group">
        <label for="title">Note Title</label>
        <input type="text" class="form-control" id="title" name="title" aria-desribedby="emailHelp">
      </div>

      <div class="form-group">
        <label for="des">Note des</label>
